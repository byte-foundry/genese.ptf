		...
		0:
			...
			nodes:
				...
				3:
					...
					y: capHeight - ( capHeight - contours[0].nodes[2].y ) / 2
					x: parentAnchors[0].x
					y: parentAnchors[0].y
					# lDir: 90 + 'deg'
				...
				5:
					...
					# rTension: 0
				6:
					x: thickness * opticThickness + contours[0].nodes[5].x + ( contours[0].nodes[5].x - anchors[3].x )
				...
				7:
					...
					y: contours[0].nodes[6]. y - ( contours[0].nodes[6]. y - anchors[5].y ) / 2
					# lDir: 90 + 'deg'
