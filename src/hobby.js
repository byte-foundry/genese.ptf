...
(function( P ) {
	...
	Object.mixin(P.hobby, {
		...
		nodeType: nodeType,
		reverseNodeType: reverseNodeType
	});
	...
	var extend = {
		...
		lx_pt: {
			get: function() { return this.lCtrl.coords[0]; },
			set: function( x ) { this.lCtrl.coords[0] = x; }
		},
		ly_pt: {
			get: function() { return this.lCtrl.coords[1]; },
			set: function( y ) { this.lCtrl.coords[1] = y; }
		},
		rx_pt: {
			get: function() { return this.rCtrl.coords[0]; },
			set: function( x ) { this.rCtrl.coords[0] = x; }
		},
		ry_pt:  {
			get: function() { return this.rCtrl.coords[1]; },
			set: function( y ) { this.rCtrl.coords[1] = y; }
		},
		left_tension: {
	...
	for ( var i in extend ) {
		Object.defineProperty(P.Node.prototype, i, extend[i]);
	}
